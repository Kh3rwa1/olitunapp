...
class _AdminGamificationScreenState
  ...
  Future<Map<String, int>> _loadAnalyticsMetrics(int reload) async {
    ...
    return {
      ...
      'Daily analytics rollups': values[9],
      'Unlocked badges': values[10],
      'Streak shield records': values[11],
      'Mistake reviews completed': values[12],
      'Mistakes needing practice': values[13],
      'Bakhed 80% completions': values[14],
      'Bakhed lyric lines': values[15],
      'Bakhed vocabulary words': values[16],
      'Published cultural notes': values[17],
    };
  }
