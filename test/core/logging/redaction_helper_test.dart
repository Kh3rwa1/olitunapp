...
void main() {
  group('RedactionHelper Tests', () {
    test('redactEmail masks username portion', () {
      expect(
        RedactionHelper.redactEmail('testuser@domain.com'),
        't***@domain.com',
      );
    ...
    test(
      'sanitize redacts embedded emails, bearer tokens, and session secrets',
      () {
        const logMsg =
            'User john.doe@example.com logged in with secret=a_session_998877 and Bearer token12345';
