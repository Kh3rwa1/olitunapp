...
class NumbersNotifier extends StateNotifier<AsyncValue<List<NumberModel>>> {
  ...
  static final List<NumberModel> _seedNumbers = [
    NumberModel(id: 'n0', numeral: '᱐', value: 0, nameOlChiki: 'ᱥᱩᱱᱭᱟ', nameLatin: 'Sunya', order: 0),
    NumberModel(id: 'n1', numeral: '᱑', value: 1, nameOlChiki: 'ᱢᱤᱫ', nameLatin: 'Mit', order: 1),
    NumberModel(id: 'n2', numeral: '᱒', value: 2, nameOlChiki: 'ᱵᱟᱨ', nameLatin: 'Bar', order: 2),
    NumberModel(id: 'n3', numeral: '᱓', value: 3, nameOlChiki: 'ᱯᱮ', nameLatin: 'Pe', order: 3),
    NumberModel(id: 'n4', numeral: '᱔', value: 4, nameOlChiki: 'ᱯᱩᱱ', nameLatin: 'Pun', order: 4),
    NumberModel(id: 'n5', numeral: '᱕', value: 5, nameOlChiki: 'ᱢᱚᱬᱮ', nameLatin: 'Mone', order: 5),
    NumberModel(id: 'n6', numeral: '᱖', value: 6, nameOlChiki: 'ᱛᱩᱨᱩᱤ', nameLatin: 'Turui', order: 6),
    NumberModel(id: 'n7', numeral: '᱗', value: 7, nameOlChiki: 'ᱮᱭᱟᱭ', nameLatin: 'Eyay', order: 7),
    NumberModel(id: 'n8', numeral: '᱘', value: 8, nameOlChiki: 'ᱤᱨᱟᱹᱞ', nameLatin: 'Iral', order: 8),
    NumberModel(id: 'n9', numeral: '᱙', value: 9, nameOlChiki: 'ᱟᱨᱮ', nameLatin: 'Are', order: 9),
  ];
