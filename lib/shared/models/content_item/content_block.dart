...
Map<String, dynamic> _extractBlockMeta(Map<String, dynamic> json) {
  return <String, dynamic>{
    ...
    if (json['textBengali'] != null) 'textBengali': json['textBengali'],
    if (json['text_bengali'] != null) 'textBengali': json['text_bengali'],
    if (json['textHindi'] != null) 'textHindi': json['textHindi'],
    if (json['text_hindi'] != null) 'textHindi': json['text_hindi'],
    if (json['textOdia'] != null) 'textOdia': json['textOdia'],
    if (json['text_odia'] != null) 'textOdia': json['text_odia'],
    if (json['meaning'] != null) 'meaning': json['meaning'],
    if (json['meaning_bn'] != null) 'meaning_bn': json['meaning_bn'],
    if (json['meaning_hi'] != null) 'meaning_hi': json['meaning_hi'],
    if (json['meaning_or'] != null) 'meaning_or': json['meaning_or'],
    if (json['meaning_en'] != null) 'meaning_en': json['meaning_en'],
    if (json['pronunciation'] != null) 'pronunciation': json['pronunciation'],
