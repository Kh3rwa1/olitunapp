...
const collections = [
  ...
  },
  {
    ...
    attrs: [
      { type: 'string', key: 'userId', size: 36, required: true },
      { type: 'string', key: 'categoryId', size: 36, required: true },
      { type: 'string', key: 'provider', size: 30, required: false },
      { type: 'string', key: 'providerOrderId', size: 255, required: false },
      { type: 'string', key: 'providerPaymentId', size: 255, required: false },
      { type: 'integer', key: 'expectedAmount', required: false },
      { type: 'integer', key: 'paidAmount', required: false },
      { type: 'string', key: 'currency', size: 10, required: false },
      ...
      { type: 'string', key: 'refundStatus', size: 30, required: false },
      { type: 'integer', key: 'refundedAmountPaise', required: false },
      { type: 'integer', key: 'refundEpoch', required: false, default: 0 },
      { type: 'string', key: 'unlockMethod', size: 30, required: false },
      { type: 'integer', key: 'amountPaidInr', required: false },
    ...
    indexes: [
      ...
      { key: 'providerPaymentId_idx', type: 'key', attributes: ['providerPaymentId'] },
    ],
  },
  {
    id: 'payment_claims',
    ...
    documentSecurity: true,
    attrs: [
      { type: 'string', key: 'paymentId', size: 255, required: true },
      { type: 'string', key: 'purchaseId', size: 255, required: true },
      { type: 'string', key: 'providerOrderId', size: 255, required: true },
      { type: 'string', key: 'userId', size: 36, required: true },
      { type: 'string', key: 'categoryId', size: 36, required: true },
      { type: 'string', key: 'status', size: 20, required: true },
      { type: 'string', key: 'claimedAt', size: 30, required: true },
      { type: 'string', key: 'committedAt', size: 30, required: false },
    ],
    indexes: [
      { key: 'paymentId_idx', type: 'unique', attributes: ['paymentId'] },
    ],
  },
  {
    id: 'refund_claims',
    ...
    documentSecurity: true,
    attrs: [
      { type: 'string', key: 'refundId', size: 255, required: true },
      { type: 'string', key: 'paymentId', size: 255, required: true },
      { type: 'string', key: 'purchaseId', size: 255, required: true },
      { type: 'integer', key: 'amountPaise', required: true },
    ...
    indexes: [
      { key: 'refundId_idx', type: 'unique', attributes: ['refundId'] },
      { key: 'payment_refund_idx', type: 'key', attributes: ['paymentId', 'refundId'] },
    ],
  },
  {
