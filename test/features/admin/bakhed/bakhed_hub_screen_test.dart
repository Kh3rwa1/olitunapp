...
void main() {
  testWidgets('Hub filter dropdown shows distinct category strings and filters correctly', (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          contentListProvider((ContentKind.rhyme, null)).overrideWith(
            (ref) => rhymes,
          ),
