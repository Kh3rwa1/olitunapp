...
/// Renders the live WYSIWYG preview for a lesson block inside the admin
/// lesson editor. Extracted from [LessonBlockCard] to keep both files
/// focused and under the repository line-length gate.
class LessonBlockPreview extends StatelessWidget {
  final LessonBlockEntity block;
  final bool isDark;

  const LessonBlockPreview({
    super.key,
    required this.block,
