...
void main() {
  ...
  group('ContentHero Multilingual Display Tests', () {
    testWidgets(
      'renders word in Bengali mode with Bengali meaning and transliteration',
      (tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            ...
            child: MaterialApp(
              home: Scaffold(
                body: ContentHero(item: wordItem, accentColor: Colors.blue),
              ),
            ),
          ),
        );
    ...
    testWidgets(
      'renders sentence in Hindi mode with Hindi meaning and Devanagari transliteration',
      (tester) async {
        final prefs = await SharedPreferences.getInstance();
    ...
    testWidgets('renders lesson item retaining regular title and subtitle', (
      tester,
    ) async {
      final prefs = await SharedPreferences.getInstance();
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: MaterialApp(
            home: Scaffold(
              body: ContentHero(item: lessonItem, accentColor: Colors.green),
            ),
          ),
        ),
      );
