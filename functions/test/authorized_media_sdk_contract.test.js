...
test('deployed media SDK supports metadata and expiring file tokens', async () => {
  ...
  assert.ok(requests[1].some(arg => arg && typeof arg === 'object' && arg.bucketId === 'paid_media' && arg.fileId === 'file'));
});
